(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["vue-response-size"] = {}, global.vue));
  ...
  var sizeMap = getSizeMap();
  var onResizeThrottle;
  init(); // 初始化

  function init() {
    var _window$name;

    console.log((_window$name = window.name) !== null && _window$name !== void 0 ? _window$name : '1');
    onResize();
  ...
  function onResize() {
    ...
    var height = window.innerHeight || document.documentElement.offsetHeight; // 设置尺寸
